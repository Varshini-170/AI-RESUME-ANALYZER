...
A Streamlit app that reads your resume (PDF or DOCX), compares it against a set of job roles, and shows you a match score, your top 3 recommended roles, missing skills, and a simple learning roadmap.
